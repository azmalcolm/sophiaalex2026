...
export const faq: FaqItem[] = [
  ...
  },
  {
    ...
    answer: 'Think Italian summer! Temperatures usually range from 25–30°C with mostly dry weather. Pack light, breathable fabrics alongside your formal attire. Don\'t forget swimwear, sunscreen, and sunglasses. Comfortable walking shoes are perfect for vineyard walks and cobbled village streets.',
  },
  {
    question: 'What airport should I fly into?',
    answer: 'The closest airports are: Turin (1h 30 by car), Genoa (2h 00), and Milan Malpensa or Linate (2h 30). We recommend hiring a car to make the most of your time in the region, but transfers and taxis are also available.',
  },
  {
    question: 'When should I arrive and leave?',
    answer: 'The welcome evening starts on Friday 3rd July at 17:30. We recommend arriving Thursday evening or Friday afternoon to settle in before the celebrations begin. The farewell brunch wraps up by 11:00 AM on Sunday 5th July.',
  },
  {
  ...
  },
  {
    ...
    answer: 'We have arranged discounted rates for our guests at Villa Beccaris for the wedding weekend. If you would like to extend your stay before or after, contact the hotel directly and mention the Söderström–Zeeman wedding.',
  },
  {
    question: 'Can I bring my children?',
    answer: 'We love your little ones, but this will be an adults-only celebration. Think of it as a well-deserved mini holiday for yourselves! We hope you can arrange childcare and join us fully.',
  },
  {
  ...
  },
  {
    ...
    answer: 'If anything unexpected happens during the wedding weekend, here\'s who to reach: Emergency services (fire, police, ambulance): 112. Wedding planner Paola Casetta: +39 339 297 7722. For all other questions: ciao@sophiaalex2026.com.',
  },
  {
  ...
  },
  {
    ...
    answer: 'We kindly ask that you put phones and cameras away during the ceremony so everyone can be fully present. Our photographer will capture every moment beautifully. After the ceremony, please snap away and tag us with #SophiaAlexItaly2026.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Please let us know any dietary requirements when you RSVP. If you have already replied and forgot to mention something, just email us at ciao@sophiaalex2026.com and we\'ll make sure the kitchen is informed.',
  },
  {
  ...
  },
  {
    ...
    answer: 'We would love to see the weekend through your eyes! Please use our wedding hashtag #SophiaAlexItaly2026 on Instagram and any other platforms. We\'ll be collecting photos after the wedding and would love to see yours.',
  },
  {
    question: 'What\'s the weather like in July?',
    answer: 'Expect warm, sunny days around 25–30°C and cooler evenings, especially in the hills of Monforte d\'Alba. July is one of the most beautiful months in Piedmont — golden light, long evenings, and the vines in full leaf.',
  },
  {
    question: 'What currency and payment options are best?',
    answer: 'Italy uses the euro (€). Cards are accepted almost everywhere, but having some cash is handy for taxis, local markets, and smaller establishments in the village. Most ATMs are available in Alba, about 15 minutes away.',
  },
  {
    question: 'Will there be good Wi-Fi and phone signal?',
    answer: 'Most hotels and restaurants offer Wi-Fi, and there is decent mobile coverage in the village. Signal in more rural parts of the Langhe can be patchy, which is honestly part of the charm — a perfect excuse to be fully present.',
  },
  {
    question: 'What if I need help during the weekend?',
    answer: 'For any questions before or during the wedding, email us at ciao@sophiaalex2026.com. During the weekend itself, our toastmasters Sandra and Lisa are your first point of contact, and our wedding planner Paola Casetta (+39 339 297 7722) is on hand for anything logistical.',
  },
];
